...
RealizationViewWidgetCornerVersion::RealizationViewWidgetCornerVersion(
    SharedDataGUI *sharedData, BondViewWidget *bondViewWidget) {
...
void RealizationViewWidgetCornerVersion::
    updateOrientationSelectionComboBoxValues(
...
void RealizationViewWidgetCornerVersion::setCayleyPoint(int cayleyPointID,
                                                        PointType pointType) {
  atomsB.clear();
...
void RealizationViewWidgetCornerVersion::setMolecularUnits(
...
void RealizationViewWidgetCornerVersion::mousePressEvent(
    QMouseEvent *mouseEvent) {
  camera.mousePressEvent(mouseEvent);
}

void RealizationViewWidgetCornerVersion::mouseReleaseEvent(
    QMouseEvent *mouseEvent) {
...
void RealizationViewWidgetCornerVersion::transformCylinderAccordingToData(
