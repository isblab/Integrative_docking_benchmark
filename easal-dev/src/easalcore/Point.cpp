...
void Point::setRadius(double radius) { this->radius = radius; }

void Point::setName(string name) { this->name = name; }

void Point::setPointID(string pointID) { this->pointID = pointID; }

double Point::getRadius() { return this->radius; }

string Point::getName() { return this->name; }

vector<string> Point::getRow() { return this->row; }

string Point::getPointID() { return this->pointID; }
...
double* Point::getLocation() { return this->loc; }
