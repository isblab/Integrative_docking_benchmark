...
for protein in 1clv_8 1dfj_4 1kxp_7 1r0r_6 2ayo_5 2b42_10 2hle_9; do
    ...
    for i in $(seq 30); do
        folder_name="$i"
        mpirun -np 4 /home/muskaan/imp-clean/build/setup_environment.sh python /home/muskaan/EASAL/scripts/sample_imp.py "prod" "$chainA" "$chainB" "$folder_name" "EDC" "20"> "err_$folder_name.log" &
    done
