...
plt.xlabel('Average Crosslink satisfaction\n percentage in IMP Ensemble (%)', fontsize=14)
plt.ylabel('Average Crosslink satisfaction\n percentage in EASAL Ensemble (%)', fontsize=14)
plt.tick_params(axis='both', which='major', labelsize=12)
plt.xlim(0, 105)
plt.ylim(0, 105)
