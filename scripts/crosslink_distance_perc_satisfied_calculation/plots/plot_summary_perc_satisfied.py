...
def file_parsing(name):
    ...
    #For imp models
    max_xlink_perc, max_models = get_perc_across_models(file1_path)
    plt.scatter(max_xlink_perc, max_models, color = 'blue')

    #For easal models
    max_xlink_perc, max_models = get_perc_across_models(file2_path)
    plt.scatter(max_xlink_perc, max_models, color = 'orange')
    print(name, max_xlink_perc, max_models)
