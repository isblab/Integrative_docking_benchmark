...
execute_process(
  COMMAND "/usr/bin/git" show-ref "53a7864c48a2b2fc226c69e9184d7cc8e6b36b6d"
  WORKING_DIRECTORY "/home/muskaan/easal-dev/include/Eigen/src/Eigen"
...
if("${show_ref_output}" MATCHES "refs/remotes/53a7864c48a2b2fc226c69e9184d7cc8e6b36b6d")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "53a7864c48a2b2fc226c69e9184d7cc8e6b36b6d")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "53a7864c48a2b2fc226c69e9184d7cc8e6b36b6d")
endif()
    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/muskaan/easal-dev/include/Eigen/src/Eigen'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/muskaan/easal-dev/include/Eigen/src/Eigen'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
